...
Online Teaching Allocation (OTA) roster management tool for The University of Sydney. This R package streamlines the process of managing teaching rosters, tracking changes, and generating reports for teaching staff assignments. It is designed for teaching staff and coordinators who need to manage and track changes to teaching rosters, handling the comparison of rosters as they are updated, identifying changes, and producing reports for submission to the University's Online Teaching Allocation (OTA) system.

If you are not from USYD there is probably not much here for you!

## Installation

You can install the development version of ota from [GitHub](https://github.com/usyd-soles-edu/ota) with:
